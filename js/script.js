var easy = ["Dieren", "Landen", "Pokemon", 
            ...
            "Dingen die je niet in de magnetron kan stoppen"
        ];
...
var loglength = 5;
//version
var version = "v3.0.2_2025";

$("#signature").append(version);

//zet de categorieën klaar
...
if(window.localStorage.key("omnibaap_darkmodestorage") != null){
darkmode = window.localStorage.getItem("omnibaap_darkmodestorage");}

//1 = achtergrond zwart
//0 = achtergrond wit

if(darkmode == 1){
    $("#helpbutton").css("border-color", "black");
    ...
    $("#helpbutton").css("border-color", "white");
...
$("#cleopatrabutton").on("click", function () {
    if(cleopatrabutton == false){
        cleopatrabutton = true;
        $("#cleopatrabutton").css("background-color", "rgb(88, 129, 87)");
        $("#cleopatrabutton").css("border", "0.74vh solid rgb(58, 90, 64)");
        $("#cleopatrabutton").css("margin-top", "1.48vh");
        
        //add to playing list
        for(i = 0; i < cleo.length; i++){
            playing.push(cleo[i]);
        }        
...
//als helpknop geklikt ((in dit geval is dit nu de darkmode knop))
$("#helpbutton").on("click", function () {
    if(window.localStorage.key("omnibaap_darkmodestorage") != null){
        darkmode = window.localStorage.getItem("omnibaap_darkmodestorage");}
    if(darkmode == 0){ //maak zwart
        $("#helpbutton").css("border-color", "black");
        $("body").css("background-color", "black");
        $("#prompt").css("color", "white");
        $("#log").css("color", "rgb(170, 170, 170)");
        ...
        //paste in local storage
        window.localStorage.setItem("omnibaap_darkmodestorage", "1");
        
        darkmode = 1;

    }else if(darkmode == 1){ //maak wit
        $("#helpbutton").css("border-color", "white");
        $("body").css("background-color", "white");
        $("#prompt").css("color", "black");
        $("#log").css("color", "rgb(70, 70, 70)");
        ...
        //paste in local storage
        window.localStorage.setItem("omnibaap_darkmodestorage", "0");

        darkmode = 0;

    }//todo: dit overzetten naar css
...
$("#button").on("click", function () {
    ...
    printprompt(difficulty);
});

//functie voor het klikken van de difficulty knop
function reply_clicked(difficultyclicked){

    if(difficultyclicked != difficulty){
        
            //cleopatra setting resetten
            $("#cleopatrabutton").css("background-color", "rgb(58, 90, 64)");
            $("#cleopatrabutton").css("border", "none");
            $("#cleopatrabutton").css("margin-top", "2.22vh");
            cleopatrabutton = false;

        difficulty = difficultyclicked;
        changedifficulty(difficultyclicked);
    }
}

//functie voor het veranderen van de difficulty
function changedifficulty(difficulty) {
         ...
         $(".difbutton#" + difficulty).toggleClass("active");
...
function printprompt(difficulty) {
    $("#button p").css("color", "rgb(255, 255, 255, 0%)");

        random = Math.floor(Math.random() * playing.length);
        ...
        if(playing.length == 1){
            setTimeout(() => {
                ...
                prompt = playing[random];

                playing.splice(random, 1);
